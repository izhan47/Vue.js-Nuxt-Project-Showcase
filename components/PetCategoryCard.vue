<template>
  <div>
    ...
    <!--      </nuxt-link>-->
    <!--    </div>-->
    <!--    <v-card  class="card-radius card-padding card-custom-height" @click="$router.push(`/find-a-pet-biz/${item.slug}`)">-->
    ...
    <!--        </p>-->
    <!--        <nuxt-link :to="`/find-a-pet-biz/${item.slug}`"><button>READ MORE</button></nuxt-link>-->
    <!--      </v-card-text>-->
